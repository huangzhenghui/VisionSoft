...
namespace Rex
{
    public class CTabControl : TabControl
    {
        ...
        private Color _pageColor = Color.Navy;
        ...
        protected virtual void OnPaintUpDownButton(UpDownButtonPaintEventArgs e)
        {
            ...
            Color upButtonBaseColor = _pageColor;
            Color upButtonBorderColor = Color.White;
            Color upButtonArrowColor = Color.White;

            Color downButtonBaseColor = _pageColor;
            Color downButtonBorderColor = Color.White;
            Color downButtonArrowColor = Color.White;
            ...
            if (Enabled)
            {
                if (e.MouseOver)
                {
                    if (e.MousePress)
                    {
                        ...
                        {
                            upButtonBaseColor = Color.DarkSlateBlue;
                        }
                        else
                        {
                            downButtonBaseColor = Color.DarkSlateBlue;
                        }
                    }
                    else
                    {
        ...
        {
            private CTabControl _owner;
            private bool _bPainting;

            public UpDownButtonNativeWindow(CTabControl owner)
                : base()
            {
                _owner = owner;
