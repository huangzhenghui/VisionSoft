...
{
    public partial class HObjectSetForm : FormBase
    {
        #region 字段、属性
        ...
        /// 模块对象
        /// </summary>
        HObjectSetObj mObj = new HObjectSetObj();
        ...
        public HObjectSetForm(HObjectSetObj Obj) : base(Obj)
        {
            InitializeComponent();
        ...
        public void ShowHObj()
        {
            ...
            if (mObj.hObjectSet_Info.hObjSet != null)
            {
                HOperatorSet.DispObj(mObj.hObjectSet_Info.hObjSet, mWindowH.HWindowHalconID);
                mWindowH.DispObj(mObj.hObjectSet_Info.hObjSet);
            }
        }
