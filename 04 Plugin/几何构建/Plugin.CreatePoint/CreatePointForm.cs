...
{
    public partial class CreatePointForm : FormBase
    {
        #region 字段、属性
        ...
        public CreatePointForm(CreatePointObj Obj) : base(Obj)
        {
            InitializeComponent();
        ...
        {
            if (mObj.createPoint_Info.pointObj != null)
            {
                HOperatorSet.DispObj(mObj.createPoint_Info.pointObj, mWindowH.HWindowHalconID);
                mWindowH.DispObj(mObj.createPoint_Info.pointObj, mObj.resultColor);
            }
        }
        ...
        public override void FormToObj()
        {
            ...
            mObj.crossWidth = tbxCrossWidth.TextInfo.Trim().ToInt();
            mObj.resultColor = ColorTranslator.ToHtml(cpShowColor.Value);
        }
        ...
        public override void ObjToForm()
        {
            ...
            tbxCrossWidth.TextInfo = mObj.crossWidth.ToString();
            cpShowColor.Value = ColorTranslator.FromHtml(mObj.resultColor);
        }
        ...
        private void ldData_LinkData(object sender, EventArgs e)
        {
            ...
            switch (myLinkData.Name)
            {
                case "ldImage":
                    ...
                    break;
                case "ldPointX":
                    LikeDataForm.dataType = "Double" + "|" + "Double[]" + "|" + "Int" + "|" + "Int[]";
                    LikeDataForm.ShowDialog();
                    if (LikeDataForm.m_OutLinkData.Length > 3)
                    {
                        string[] m_IntStr = LikeDataForm.m_OutLinkData.Split('|');
