...
{
    public partial class ShapeTransForm : FormBase
    {
        #region 字段、属性
        ...
        public ShapeTransForm(ShapeTransObj Obj) : base(Obj)
        {
            InitializeComponent();
        ...
        public void ShowHObj()
        {
            ...
            if (mObj.shapeTrans_Info.resultReg != null)
            {
                HOperatorSet.DispObj(mObj.shapeTrans_Info.resultReg, mWindowH.HWindowHalconID);
                mWindowH.DispObj(mObj.shapeTrans_Info.resultReg);
            }
        }
