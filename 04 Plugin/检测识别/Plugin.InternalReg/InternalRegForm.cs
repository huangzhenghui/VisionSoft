...
{
    public partial class InternalRegForm : FormBase
    {
        #region 字段、属性
        ...
        public InternalRegForm(InternalRegObj Obj) : base(Obj)
        {
            InitializeComponent();
        ...
        public void ShowHObj()
        {
            ...
            HOperatorSet.ConcatObj(mObj.internalReg_Info.regionObj, mObj.inputReg, out objAssem);
