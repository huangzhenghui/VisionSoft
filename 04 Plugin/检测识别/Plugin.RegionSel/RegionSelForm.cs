...
{
    public partial class RegionSelForm : FormBase
    {
        #region 字段、属性
        ...
        public RegionSelForm(RegionSelObj Obj) : base(Obj)
        {
            InitializeComponent();
        ...
        public void ShowHObj()
        {
            ...
            if (mObj.regionSel_Info.regionObj != null)
            {
                HOperatorSet.DispObj(mObj.regionSel_Info.regionObj, mWindowH.HWindowHalconID);
                mWindowH.DispObj(mObj.regionSel_Info.regionObj);
            }
        }
        ...
        public override void FormToObj()
        {
            ...
            mObj.min = tbxMin.TextInfo.Trim().ToDouble();
            mObj.max = tbx1Max.TextInfo.Trim().ToDouble();
        ...
        public override void ObjToForm()
        {
            ...
            tbx1Max.TextInfo = mObj.max.ToString();
