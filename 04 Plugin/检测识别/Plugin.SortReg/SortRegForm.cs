...
{
    public partial class SortRegForm : FormBase
    {
        #region 字段、属性
        ...
        public SortRegForm(SortRegObj Obj) : base(Obj)
        {
            InitializeComponent();
        ...
        public void ShowHObj()
        {
            ...
            HOperatorSet.DispObj(mObj.sortReg_Info.resultReg, mWindowH.HWindowHalconID);
            mWindowH.DispObj(mObj.sortReg_Info.resultReg);
        }
        ...
        public override void FormToObj()
        {
            ...
            mObj.sortMode = cbxSortMode.Text;
            mObj.order = cbxOrder.Text;
            mObj.rowOrCol = cbxRowOrCol.Text;
        ...
        public override void ObjToForm()
        {
            ...
            cbxSortMode.Text = mObj.sortMode;
            cbxOrder.Text = mObj.order;
            cbxRowOrCol.Text = mObj.rowOrCol;
