...
{
    public partial class OperateRegForm : FormBase
    {
        #region 字段、属性
        ...
        public OperateRegForm(OperateRegObj Obj) : base(Obj)
        {
            InitializeComponent();
        ...
        public void ShowHObj()
        {
            ...
            if (mObj.operateReg_Info.regionObj != null)
            {
                HOperatorSet.DispObj(mObj.operateReg_Info.regionObj, mWindowH.HWindowHalconID);
                mWindowH.DispObj(mObj.operateReg_Info.regionObj);
            }
        }
        ...
        public override void FormToObj()
        {
            ...
            mObj.operateMode = cbxMode.Text;
            mObj.inputReg1Name = ldRegion1.TextInfo.Trim();
            mObj.inputReg2Name = ldRegion2.TextInfo.Trim();
        ...
        public override void ObjToForm()
        {
            ...
            cbxMode.Text = mObj.operateMode;
            ldRegion1.TextInfo = mObj.inputReg1Name;
            ldRegion2.TextInfo = mObj.inputReg2Name;
        ...
        private void ldData_LinkData(object sender, EventArgs e)
        {
            ...
            switch (myLinkData.Name)
            {
                ...
                case "ldRegion1":
                    ...
                    {
                        string[] m_IntStr = LikeDataForm.m_OutLinkData.Split('|');
                        ldRegion1.TextInfo = m_IntStr[0] + ":" + m_IntStr[1];
                    }
                    break;
                case "ldRegion2":
                    LikeDataForm.dataType = "HObject";
                    ...
                    {
                        string[] m_IntStr = LikeDataForm.m_OutLinkData.Split('|');
                        ldRegion2.TextInfo = m_IntStr[0] + ":" + m_IntStr[1];
                    }
                    break;
                case "ldRegion":
                    LikeDataForm.dataType = "HObject";
        ...
        {
            if (cbxMode.SelectedText == "求和(One)")
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void OperateRegForm_Load(object sender, EventArgs e)
        {
            mWindowH.Draw = (ShowDraw)Enum.Parse(typeof(ShowDraw), cbxDraw.Text);
