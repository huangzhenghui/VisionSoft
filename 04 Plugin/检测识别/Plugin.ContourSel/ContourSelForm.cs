...
{
    public partial class ContourSelForm : FormBase
    {
        #region 字段、属性
        ...
        public ContourSelForm(ContourSelObj Obj) : base(Obj)
        {
            InitializeComponent();
            mObj = Obj;
        ...
        public void ShowOutputHObj()
        {
            ...
            //获取HObject
            if (mObj.contourSel_Info.contourObj == null || !mObj.contourSel_Info.contourObj.IsInitialized()) return;
            contours = mObj.contourSel_Info.contourObj;
        ...
        public void ShowInputHObj()
        {
            try
            {
                ...
                if (mObj.inputContour.IsInitialized())
                {
                    HOperatorSet.SetColored(mWindowH.HWindowHalconID, 12);
                    HOperatorSet.DispObj(mObj.inputContour, mWindowH.HWindowHalconID);
                    mWindowH.DispObj(mObj.inputContour);
                }
            }
            catch { }
        }
        ...
        {
            if (mObj.contourSel_Info.contourObj != null && mObj.contourSel_Info.contourObj.IsInitialized())
            {
                ShowOutputHObj();
            }
            else
        ...
        public void ShowResult()
        {
            ...
            resultForm.ShowResult(mObj.exeResult, mObj.contourSel_Info.contourNum);
            resultForm.Show();
        }
        ...
        public override void FormToObj()
        {
            ...
            mObj.strInputContour = ldContour.TextInfo.Trim();
            mObj.feature = cbxShape.Text;
            mObj.min = Convert.ToDouble(tbxMin.TextInfo.Trim());
            mObj.max = Convert.ToDouble(tbxMax.TextInfo.Trim());
        ...
        public override void ObjToForm()
        {
            ...
            ldContour.TextInfo = mObj.strInputContour;
            cbxShape.Text = mObj.feature;
            tbxMin.TextInfo = mObj.min.ToString();
            tbxMax.TextInfo = mObj.max.ToString();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ContourSelForm_Load(object sender, EventArgs e)
        {
            ShowImage();
            ShowHObj();
            ShowResult();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ContourSelForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (resultForm != null)
            {
                resultForm.Close();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ContourSelForm_LocationChanged(object sender, EventArgs e)
        {
            if (resultForm != null)
            {
                Point point = new Point();
