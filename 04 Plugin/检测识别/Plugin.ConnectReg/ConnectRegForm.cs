...
{
    public partial class ConnectRegForm : FormBase
    {
        #region 字段、属性
        ...
        public ConnectRegForm(ConnectRegObj Obj) : base(Obj)
        {
            InitializeComponent();
        ...
        public void ShowHObj()
        {
            ...
            if (mObj.connectReg_Info.regionObj != null)
            {
                HOperatorSet.DispObj(mObj.connectReg_Info.regionObj, mWindowH.HWindowHalconID);
                mWindowH.DispObj(mObj.connectReg_Info.regionObj);
            }
        }
