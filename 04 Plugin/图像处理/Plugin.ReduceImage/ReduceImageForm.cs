...
{
    public partial class ReduceImageForm : FormBase
    {
        #region 字段、属性
        ...
        public ReduceImageForm(ReduceImageObj Obj) : base(Obj)
        {
            InitializeComponent();
            mObj = Obj;
        }
        ...
        public void ShowHObj()
        {
            ...
            mWindowH.HobjectToHimage(mObj.reduceImage_Info.imageObj);
        }
        ...
        public override void FormToObj()
        {
            ...
            mObj.regionName = ldRegion.TextInfo.Trim();
            mObj.GetData();
        ...
        public override void ObjToForm()
        {
            ...
            ldRegion.TextInfo = mObj.regionName;
