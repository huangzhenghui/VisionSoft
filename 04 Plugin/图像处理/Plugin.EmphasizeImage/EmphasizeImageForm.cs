...
{
    public partial class EmphasizeImageForm : FormBase
    {
        #region 字段、属性
        ...
        public EmphasizeImageForm(EmphasizeImageObj Obj) : base(Obj)
        {
            InitializeComponent();
            mObj = Obj;
        }
        ...
        public void ShowHObj()
        {
            ...
            mWindowH.HobjectToHimage(mObj.emphasisImage_Info.imageObj);
        }
        ...
        public override void FormToObj()
        {
            ...
            mObj.maskWidth = tbxWidth.TextInfo.Trim().ToInt();
            mObj.maskHeight = tbxHeight.TextInfo.Trim().ToInt();
            mObj.factor = tbxFactor.TextInfo.ToDouble();
            mObj.GetData();
        ...
        public override void ObjToForm()
        {
            ...
            tbxWidth.TextInfo = mObj.maskWidth.ToString();
            tbxHeight.TextInfo = mObj.maskHeight.ToString();
            tbxFactor.TextInfo = mObj.factor.ToString();
