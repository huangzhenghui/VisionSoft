...
{
    public partial class ScaleGrayForm : FormBase
    {
        #region 字段、属性
        ...
        /// 模块对象
        /// </summary>
        ScaleGrayObj mObj = new ScaleGrayObj();
        ...
        public ScaleGrayForm(ScaleGrayObj Obj) : base(Obj)
        {
            InitializeComponent();
            mObj = Obj;
        }
        ...
        public void ShowHObj()
        {
            ...
            mWindowH.HobjectToHimage(mObj.scaleGray_Info.imageObj);
        }
        ...
        public override void FormToObj()
        {
            ...
            mObj.scaleFactor = tbScaleFactor.Value;
            mObj.offset = tbOffset.Value;
            mObj.GetData();

            //tab2
            mObj.isShow = chxShow.Checked;
        ...
        public override void ObjToForm()
        {
            ...
            tbScaleFactor.Value = mObj.scaleFactor;
            tbOffset.Value = mObj.offset;

            //Tab2
            chxShow.Checked = mObj.isShow;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void tbScaleFactor_ValueChanged(object sender, EventArgs e)
        {
            if (isExeEvent)
            {
                FormToObj();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ScaleGrayForm_Load(object sender, EventArgs e)
        {
            isExeEvent = true;
        }
