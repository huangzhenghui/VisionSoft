...
namespace TSIVision.FrmConfigR
{
    ...
    public delegate void DgClearMbsParams(CommunicationModel commModel);

    /// <summary>
    /// Mbs连接参数窗体
    /// </summary>
    public partial class FrmMbsMenu : Form
    {
        #region 字段、属性
        ...
        /// 声明委托
        /// </summary>
        public DgClearMbsParams dgClearMbsParams;
        ...
        {
            dgClearMbsParams(CommunicationModel.Mbs);
            Hide();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void FrmMbsMenu_Load(object sender, EventArgs e)
        {
            tbxAimIP.Focus();
        }
