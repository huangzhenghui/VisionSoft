...
namespace TSIVision.FrmConfigR
{
    ...
    public delegate void DgClearServerParams(CommunicationModel commModel);

    public partial class FrmServerMenu : Form
    {
        #region 字段、属性
        ...
        /// 声明委托
        /// </summary>
        public DgClearClientParams dgClearServerParams;

        #endregion

        #region 初始化

        public FrmServerMenu()
        {
            InitializeComponent();
        }
        ...
        {
            dgClearServerParams(CommunicationModel.TcpServer);
            Hide();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void FrmServerMenu_Load(object sender, EventArgs e)
        {
            tbxLocalIP.Focus();
        }
